    ...
    return (
        ...
        <Row id="technologies">
            ...
            <Row className="targets" xs={12} sm={12} md={12} xl={12} xxl={12}>
                <Col className="card-father-html w" xs={4} sm={4} md={3} xl={3} xxl={3}>
                ...
                <Col className="card-father-css w" xs={4} sm={4} md={3} xl={3} xxl={3}>
                ...
                <Col className="card-father-js w" xs={4} sm={4} md={3} xl={3} xxl={3}>
                ...
                <Col className="card-father-react w" xs={4} sm={4} md={3} xl={3} xxl={3}>
                ...
                <Col className="card-father-github w" xs={4} sm={4} md={3} xl={3} xxl={3}>
                ...
                <Col className="card-father-nodejs w" xs={4} sm={4} md={3} xl={3} xxl={3}>
                ...
                <Col className="card-father-redux w" xs={6} sm={4} md={3} xl={3} xxl={3}>
                ...
                <Col className="card-father-mysql w" xs={6} sm={4} md={3} xl={3} xxl={3}>
